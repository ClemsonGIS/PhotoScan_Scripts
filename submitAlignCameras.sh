...
#Starts PhotoScan offscreen and runs the Python Script AlignCameras.py and passes arguments.txt as an argument to the script
sh $photoscan/photoscan.sh -platform offscreen -r $ad/AlignCameras.py $cwd/arguments.txt
