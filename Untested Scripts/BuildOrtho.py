...
# Script submits a task that builds the orthomosaic in our previously created project
...
task7.params['network_distribute'] = True
...
batch_id7 = client.createBatch(filePath, [task7])

# Send the batch to the server node for processing
client.resumeBatch(batch_id7)
print("Job started...")
print("Building Dense Cloud...")

# Get the current status dictionary of the batch
stat = client.batchStatus(batch_id7)
