...
#Starts PhotoScan offscreen and runs the Python Script BuildDepthMaps.py and passes arguments.txt as an argument to the script
sh $photoscan/photoscan.sh -platform offscreen -r $ad/BuildDepthMaps.py $cwd/arguments.txt
